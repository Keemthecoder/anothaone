...
name = raw_input("What is your name, my dude?")
...
if month < current_month:
    print "Your birthday is in " + str(month - current_month + 12) + " months "
else:
    print "Your birthday is in " + str(month - current_month) + " months "
if day < current_day:
